...
public class OnlineEntertainmentController {
    ...
    @PostMapping
    public ResponseEntity<OnlineEntertainment> createOnlineEntertainment(@RequestBody OnlineEntertainment onlineEntertainment) {
   ...
   @PutMapping("/{id}")
    ...
    @GetMapping("/movie/{id}")
    public ResponseEntity<OnlineEntertainment> getMovieById(@PathVariable int id) {
    ...
    @GetMapping("/serie/{id}/season/{seasonNumber}/episode/{episodeNumber}")
    public ResponseEntity<OnlineEntertainment> getFormattedTvShow(@PathVariable int id, @PathVariable int seasonNumber, @PathVariable int episodeNumber) {
        return ResponseEntity.ok(onlineEntertainmentService.getFormattedTvShow(id, seasonNumber, episodeNumber));
    }
